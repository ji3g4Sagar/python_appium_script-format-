...
class script():
	...
	def addbloodsugar(self):
		...
		self.sp.swipeUp(n=1)
		self.ct.clickFromManyThings("com.lavidatec.wacare:id/healthLeveltx", 3)
		self.wf.explicitWait("com.lavidatec.wacare:id/iv_mybloodSugar_Plus")
		self.ct.click("com.lavidatec.wacare:id/iv_mybloodSugar_Plus")
		self.wf.explicitWait("com.lavidatec.wacare:id/tv_measure_time")
		self.ct.clickFromManyThings("com.lavidatec.wacare:id/tv_measure_time", 1)
		self.ct.click("com.lavidatec.wacare:id/tv_next_step")
		self.ec.enter("8", "com.lavidatec.wacare:id/et_blood_sugar")
		self.ct.click("com.lavidatec.wacare:id/tv_submit")
		sleep(5)
