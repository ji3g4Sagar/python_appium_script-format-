...
class script():
	...
	def recommendFriend(self):
		...
		self.ct.clickFromManyThings("com.lavidatec.wacare:id/iv_fun_icon", 4)
		self.wf.explicitWait("com.lavidatec.wacare:id/inviteButton")
		self.ct.click("com.lavidatec.wacare:id/inviteButton")
