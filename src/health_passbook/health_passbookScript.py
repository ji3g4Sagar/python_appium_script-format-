...
class script():
	...
	def tester(self):
		...
		self.ec.enter("7389", self.apkVersionIdName+"/et_healthIdMiddleNumber")
		self.ec.enter("8381", self.apkVersionIdName+"/et_healthIdEndNumber")
		self.ec.enter("87654321", self.apkVersionIdName+"/et_healthIdPassword")
		sleep(10)
