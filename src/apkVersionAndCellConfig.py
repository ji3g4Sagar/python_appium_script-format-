...
import os
class Config():
	def __init__(self, apkName="qaWaCare-v1.0.13.9.2.apk", desired_caps_outer={}, port ="4723"):#proWaCare-v1.0.12.7.apk, qaWaCare-v1.0.13.9.2.apk  devWaCare-googlePlay-alpha-v1.0.13.9.apk
