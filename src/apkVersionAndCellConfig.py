...
import os
class Config():
	def __init__(self, apkName="proWaCare-googlePlay-alpha-v1.0.11.5.apk", desired_caps_outer={}, port ="4723"):#proWaCare-googlePlay-alpha-v1.0.11.5.apk, qaExternalWaCare-v1.0.12.0.4.apk
