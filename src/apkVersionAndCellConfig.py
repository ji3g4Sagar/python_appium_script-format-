...
import os
class Config():
	def __init__(self, apkName="test", desired_caps_outer={}, port ="4723"):#proWaCare-v1.0.15.6.apk, qaWaCare-v1.0.14.0.7.apk devWaCare-googlePlay-alpha-v1.0.13.9.apk proWaCareAlpha-v1.0.14.2.apk
