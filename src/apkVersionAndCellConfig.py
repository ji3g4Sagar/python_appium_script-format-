...
import os
class Config():
	def __init__(self, apkName="proWaCare-v1.0.12.7.apk", desired_caps_outer={}, port ="4723"):#proWaCare-v1.0.12.7.apk, qaExternalWaCare-v1.0.12.0.4.apk proWaCare-v1.0.11.5.apk
